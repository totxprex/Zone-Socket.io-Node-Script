    ...
    dbSockets
      ...
      .then(function () {
        ...
        userSocket.on(
          ...
          function (pushNotificationType, toWhichUserName, senderUserName) {
            dbSockets
              .findOne({ username: toWhichUserName })
              .then(function (data) {
                let recievingUserSocketId = data.socketId;

                userSocket
                  .to(recievingUserSocketId)
                  .emit("takePushNotification", pushNotificationType, senderUserName);
              })
              .catch(function () {
